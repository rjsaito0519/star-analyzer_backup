...
#include "StMaker/StXiKFParticleMaker/StXiKFParticleMaker.h"
...
Int_t anaXi_KFParticle(
    const Char_t* inputFile = "config/picoDstList/auau3p9fxt_test.list",
    const Char_t* outputFile = "rootfile/auau3p9fxt_anaXi_KFParticle_temp/auau3p9fxt_anaXi_KFParticle_temp.root",
  ...
  else config = "config/mainconf/main_auau3p9fxt_anaXi_KFParticle.yaml";
  ...
  StXiKFParticleMaker* maker = new StXiKFParticleMaker("xiKFParticle", pico, outputFile);
