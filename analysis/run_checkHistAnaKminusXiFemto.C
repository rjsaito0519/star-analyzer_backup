// run_checkHistAnaKminusXiFemto.C - Load libStarAnaConfig, compile checkHist, call it.

void run_checkHistAnaKminusXiFemto(const Char_t* rootFile,
                                  ...
                                  const Char_t* mainconfPath = 0)
{
  ...
  gROOT->ProcessLine(TString::Format(".L %s/common/macro/checkHistAnaKminusXiFemto.C+", pwd));
  checkHistAnaKminusXiFemto(rootFile, anaName, mainconfPath);
}
