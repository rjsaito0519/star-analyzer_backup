// anaKminusXiFemto.C - StChain-based K--Xi- Femtoscopy analysis macro
// Usage: run via run_anaKminusXiFemto.C wrapper
...
#include "StMaker/StKminusXiFemtoMaker/StKminusXiFemtoMaker.h"
...
StChain* chain = 0;
StXiMaker* xiMaker = 0;
StKminusXiFemtoMaker* femtoMaker = 0;

void anaKminusXiFemto(const Char_t* inputFile = "config/picoDstList/auau19GeV.list",
                     const Char_t* outputFile = "rootfile/auau19_anaKminusXiFemto_temp/auau19_anaKminusXiFemto_temp.root",
                     ...
                     const Char_t* configPath = 0)
{
  ...
  femtoMaker = new StKminusXiFemtoMaker("kminusXiFemto", picoMaker, xiMaker, outputFile);
