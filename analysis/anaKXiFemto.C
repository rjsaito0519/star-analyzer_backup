// anaKXiFemto.C - StChain-based K0-Xi Femtoscopy analysis macro
// Usage: run via run_anaKXiFemto.C wrapper
...
#include "StMaker/StKXiFemtoMaker/StKXiFemtoMaker.h"
#include "ConfigManager.h"
#include <iostream>
#include <fstream>

StChain* chain = 0;
StK0shortMaker* k0Maker = 0;
StXiMaker* xiMaker = 0;
StKXiFemtoMaker* femtoMaker = 0;

void anaKXiFemto(const Char_t* inputFile = "config/picoDstList/auau19GeV.list",
                 const Char_t* outputFile = "rootfile/auau19_anaKXiFemto_temp/auau19_anaKXiFemto_temp.root",
                 ...
                 const Char_t* configPath = 0)
{
  ...
  // We pass dummy outputs for the intermediate V0/Cascade makers
  TString k0Out = "dummy_k0.root";
  TString xiOut = "dummy_xi.root";

  k0Maker = new StK0shortMaker("k0short", picoMaker, k0Out.Data());
  xiMaker = new StXiMaker("xi", picoMaker, xiOut.Data());
  femtoMaker = new StKXiFemtoMaker("kXiFemto", picoMaker, k0Maker, xiMaker, outputFile);
